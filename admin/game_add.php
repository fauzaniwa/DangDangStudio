...
<body class="bg-gray-50 text-slate-800">
            ...
            <main class="flex-1 flex flex-col min-w-0 overflow-y-auto">
                ...
                <div class="p-6 md:p-10 flex-1">
                    <div class="max-w-5xl mx-auto">
                        <a href="game_info.php" class="inline-flex items-center gap-2 text-sm font-bold text-gray-400 hover:text-brandGold transition mb-8">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                            Back to Game Portfolio
                        </a>

                        <form action="process_add_game.php" method="POST" enctype="multipart/form-data" class="space-y-8 pb-20">
                            ...
                            <div class="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div class="group relative">
                                        ...
                                        <div class="relative h-52 rounded-[24px] border-2 border-dashed border-gray-200 bg-gray-50 flex items-center justify-center overflow-hidden transition-all group-hover:border-brandGold/50">
                                            ...
                                            <input type="file" id="header-input" name="header_image" accept="image/*" onchange="previewSingle(this, 'header-prev')" class="absolute inset-0 opacity-0 cursor-pointer z-30">
                                    ...
                                    <div class="group relative">
                                        ...
                                        <div class="relative h-52 rounded-[24px] border-2 border-dashed border-gray-200 bg-gray-50 flex items-center justify-center overflow-hidden transition-all group-hover:border-brandGold/50">
                                            ...
                                            <input type="file" id="logo-input" name="game_logo" accept="image/*" onchange="previewSingle(this, 'logo-prev')" class="absolute inset-0 opacity-0 cursor-pointer z-30">
                                ...
                                <div class="mt-10">
                                    ...
                                    <div class="relative mb-6">
                                        <input type="file" id="screenshot-input" name="screenshots[]" multiple accept="image/*" class="absolute inset-0 opacity-0 cursor-pointer z-20">
    ...
    <script>
        // Preview untuk Header & Logo Tunggal
        ...
        // Logic Multiple Screenshot dengan Preview & Delete & Sortable
                ...
                reader.onload = e => {
                    ...
                    div.innerHTML = `
                        ...
                        <div class="absolute inset-0 bg-brandPrimary/60 opacity-0 group-hover:opacity-100 transition flex flex-col items-center justify-center gap-2">
                            <span class="text-[8px] text-white font-bold uppercase tracking-widest">Hold to Drag</span>
                            <button type="button" onclick="removeScreenshot(this)" class="bg-red-500 text-white p-2 rounded-xl hover:scale-110 transition shadow-lg">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                            </button>
                        </div>
                        <input type="hidden" name="screenshot_order[]" value="${file.name}">
                    `;
                    previewContainer.appendChild(div);
                }
                reader.readAsDataURL(file);
            });
            this.value = ""; // Reset input agar bisa pilih file yang sama
        });
