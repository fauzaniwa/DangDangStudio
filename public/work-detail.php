...
<head>
    ...
    <style>
        ...
        .article-content {
            ...
            /* Ini akan mengubah \n menjadi <br> secara otomatis oleh browser */
        }
        ...
        .article-content p {
            ...
            line-height: 1.8;
            color: #475569;
            /* Jangan gunakan pre-line di sini jika teks tidak dibungkus <p>, 
       tapi gunakan di container utamanya */
        }
...
<body x-data="detailHandler()">
    ...
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 relative mt-10">
        ...
        <main class="lg:col-span-9 lg:col-start-3 order-1 lg:order-2">
            ...
            <article class="article-content max-w-none mb-24 whitespace-pre-line text-slate-600 leading-relaxed text-lg">
                <h2 class="flex items-center gap-4 !whitespace-normal">
                    <span class="w-12 h-1 bg-[#019E9A] rounded-full inline-block"></span>
                    Description
                </h2>
                <?= htmlspecialchars(string: $game['long_desc']) ?>
            </article>
    ...
    <div x-show="showModal" x-cloak class="fixed inset-0 z-[500] flex items-end md:items-center justify-center no-print p-4">
        ...
        <div x-show="showModal"
            ...
            <button @click="copyLink()"
                ...
                <svg x-show="!copied" class="w-5 h-5 text-[#333A73]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <svg x-show="copied" class="w-5 h-5 text-white animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
